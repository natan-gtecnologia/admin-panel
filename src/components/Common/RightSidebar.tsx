...
const RightSidebar = () => {
  ...
  function tog_show() {
    setShow(!show);
    handleChangeLeftSidebarType("gradient");
  }

  useEffect(() => {
    const sidebarDark = document?.getElementById(
      "sidebar-color-dark"
    ) as HTMLInputElement;
    const sidebarLight = document?.getElementById(
      "sidebar-color-light"
    ) as HTMLInputElement;
    if (show && sidebarDark && sidebarLight) {
                  ...
                  <div className="col-4">
                    <div className="form-check card-radio">
                      <input
                        ...
                        onChange={(e) => {
                          if (e.target.checked) {
                            onChangeLayoutType(layoutTypes.VERTICAL);
                          }
                        }}
                  ...
                  <div className="col-4">
                    <div className="form-check card-radio">
                      <input
                        ...
                        onChange={(e) => {
                          if (e.target.checked) {
                            onChangeLayoutType(layoutTypes.HORIZONTAL);
                          }
                        }}
                        className="form-check-input"
                      />
                  ...
                  {/*<div className="col-4">
                    <div className="form-check card-radio">
                      <input
                        ...
                        onChange={(e) => {
                          if (e.target.checked) {
                            onChangeLayoutType(layoutTypes.TWOCOLUMN);
                          }
                        }}
                        className="form-check-input"
                      />
                    ...
                    <div className="col-4">
                      <div className="form-check card-radio dark">
                        <input
                          ...
                          onChange={(e) => {
                            if (e.target.checked) {
                              onChangeLayoutMode(layoutModeTypes.DARKMODE);
                            }
                          }}
                        />
                        <label
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                if (e.target.checked) {
                                  ...
                                  handleChangeLeftsidbarSizeType("lg");
                                }
                              }}
                            />
                            <label
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                if (e.target.checked) {
                                  ...
                                  handleChangeLeftsidbarSizeType("sm-hover");
                                }
                              }}
                            />
                            <label
                  ...
                  <div className="col-4">
                    <div className="form-check card-radio">
                      <input
                        ...
                        onChange={(e) => {
                          if (e.target.checked) {
                            handleChangeTopbarThemeType(topbarThemeTypes.LIGHT);
                          }
                        }}
                      />
                      <label
                  ...
                  <div className="col-4">
                    <div className="form-check card-radio">
                      <input
                        ...
                        onChange={(e) => {
                          if (e.target.checked) {
                            handleChangeTopbarThemeType(topbarThemeTypes.DARK);
                          }
                        }}
                      />
                      <label
                    ...
                    <div className="col-4">
                      <div className="form-check sidebar-setting card-radio">
                        <input
                          ...
                          onChange={(e) => {
                            if (e.target.checked) {
                              handleChangePreloader(preloaderTypes.ENABLE);
                            }
                          }}
                        />
                    ...
                    <div className="col-4">
                      <div className="form-check sidebar-setting card-radio">
                        <input
                          ...
                          onChange={(e) => {
                            if (e.target.checked) {
                              handleChangePreloader(preloaderTypes.DISABLE);
                            }
                          }}
                        />
                        <label
