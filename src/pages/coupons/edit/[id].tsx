...
const Edit: NextPageWithLayout<EditProps> = ({
  ...
  const { data: coupon, isFetching } = useQuery(
    ...
    async () => {
      ...
      return convert_coupon_strapi(data.data);
    },
    {
  ...
  return (
    <div className="page-content">
      <Head>
        <title>Editar cupom - GrowForce</title>
      </Head>
      <BreadCrumb title="Edição de coupon" pageTitle="Ecommerce" />
      {!isFetching && (
        <CreateOrUpdateCoupon
          coupon={{
            ...
            accumulative: coupon.accumulative || false
          }}
          type={type}
        />
      )}
