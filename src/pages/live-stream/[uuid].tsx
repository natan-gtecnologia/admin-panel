...
const LiveStream: NextPageWithLayout<LiveStreamProps> = ({
  ...
  const {
    data: liveStream,
    refetch: handleRefetchLiveStream,
  } = useQuery(
    ['liveStream'],
    async () => {
            ...
            <Card>
              <Card.Header className="card-header">
                <div className="d-flex align-items-center">
                  <h5 className="card-title mb-0 flex-grow-1">Gerenciamento da Live</h5>
                </div>
              </Card.Header>
                ...
                <Row>
                  <Col lg={4}>
                    <div className="ratio ratio-9x16" style={customStyle}>
                      <iframe src={`http://localhost:3000/${liveStream.uuid}?step=live-room`} title="YouTube video" allowFullScreen></iframe>
                    </div>
                  </Col>
                  ...
                  >
                    ...
                    <TabContent activeTab={activeTab} >
                      <TabPane tabId={1} id="pills-bill-info">
                        <SimpleBar autoHide={false} className="simplebar-track-primary" style={{ maxHeight: '560px', overflow: 'auto' }}>
